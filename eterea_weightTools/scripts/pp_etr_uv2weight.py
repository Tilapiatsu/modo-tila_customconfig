...
#			Small bits by Cristobal Vila, etereaestudios.com
#
#
# Created:     01/03/2014
...
if mode == 'U':
	lx.eval('vertMap.math "WGHT[1]:%s" "TXUV[2]:%s" 1.0 0.0 direct 0 {} 1.0 0.0 direct 0' % (vmap_name, vmap_name))
else:
	lx.eval('vertMap.math "WGHT[1]:%s" "TXUV[2]:%s" 1.0 0.0 component 1 {} 1.0 0.0 direct 0' % (vmap_name, vmap_name))
