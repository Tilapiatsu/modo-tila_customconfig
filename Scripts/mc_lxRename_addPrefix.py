...
# File: mc_lxRename_addPrefix.py
# Author: Matt Cox
# Description: Bulk renames a selection of items, adding a prefix, defined by the psString user variable.
...
try:
    ...
    for x in lxRSelectedItems:
        ...
        try:
            lxRNewNameM = str(lxRAppendString) + lxRMeshNameM
